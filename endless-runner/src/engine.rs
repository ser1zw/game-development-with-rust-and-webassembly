...
pub struct KeyState {
    processed_keys: HashMap<String, web_sys::KeyboardEvent>,
}
...
impl KeyState {
    ...
    pub fn is_pressed(&self, code: &str) -> bool {
        self.processed_keys.contains_key(code)
    }

    fn set_pressed(&mut self, code: &str, event: web_sys::KeyboardEvent) {
        self.processed_keys.insert(code.into(), event);
    }

    fn set_released(&mut self, code: &str) {
        self.processed_keys.remove(code.into());
    }
}
